...
namespace Neolix.Device.Tools
{
    ...
    public class FileEx
    {
        ...
        public static void WriteFile(IntPtr hFile, byte[] lpBuffer, int nNumberOfBytesToWrite,
                                     ref int lpNumberOfBytesWritten)
        {
            ...
            b =
                Convert.ToBoolean(WriteFileCE(hFile, lpBuffer, nNumberOfBytesToWrite, ref lpNumberOfBytesWritten,
                                              IntPtr.Zero));
        ...
        public static void ReadFile(IntPtr hFile, byte[] lpBuffer, int nNumberOfBytesToRead, ref int lpNumberOfBytesRead)
        {
            ...
            b =
                Convert.ToBoolean(ReadFileCE(hFile, lpBuffer, nNumberOfBytesToRead, ref lpNumberOfBytesRead, IntPtr.Zero));
        ...
        private static void CheckHandle(IntPtr handle)
        {
            ...
            {
                throw new WinAPIException( "File operation failed: invalid handle", Marshal.GetLastWin32Error());
            }
        }
        ...
        internal static extern bool SetFileTime(IntPtr hFile, byte[] lpCreationTime, byte[] lpLastAccessTime,
